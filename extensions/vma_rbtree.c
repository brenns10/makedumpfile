...
{
	if (!KERN_STRUCT_MEMBER_EXIST(vm_area_struct, vm_rb) ||
	    !KERN_STRUCT_MEMBER_EXIST(rb_root, rb_node) ||
	    !KERN_STRUCT_MEMBER_EXIST(rb_node, rb_left) ||
	    !KERN_STRUCT_MEMBER_EXIST(rb_node, rb_right)) {
